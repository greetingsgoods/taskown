...
<div class="bx-honour-layout">
	<?
	foreach ($arResult['ENTRIES'] as $arEntry) //foreach ($arResult['USERS'] as $arUser)
	{
		...
		?>
        <div class="" style="border: solid 1px #D8E3E8;margin-bottom: 2em;padding: 1em;">
			<?= $arResult['HONOURBYUSER'][$arUser['ID']]; ?></div>
		<?
	}
	?>
</div>
