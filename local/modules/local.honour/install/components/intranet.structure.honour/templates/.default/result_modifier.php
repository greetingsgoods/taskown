...
//if (!class_exists(\Local\Honour\HMain)) {
\Bitrix\Main\Loader::includeModule('local.honour');
//}
$objHonour = new \Local\Honour\HMain();
$resHonour = $objHonour->getArHonours();
$arResult['HONOUR'] = $resHonour;
$resHonourByUser = [];
array_walk($resHonour, function ($v, $k) use (&$resHonourByUser) {
	$resHonourByUser[$v['idUser']] = $v['strHonour'];
});
$arResult['HONOURBYUSER'] = $resHonourByUser;
